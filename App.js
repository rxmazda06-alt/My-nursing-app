...
useEffect(()=>{loadAll().then(d=>{setIsPro(d.pro);setAnxMode(d.anx);setPerf(d.perf);setStreak(d.streak);setHistory(d.hist);setScreen(d.disc?‘home’:‘disclaimer’);});},[]);
...
// HOME SCREEN
// ═══════════════════════════════════════════════════════════
function HomeScreen({cases,onStart,perf,streak,isPro,anxMode,toggleAnx,goStats,goPay}){
